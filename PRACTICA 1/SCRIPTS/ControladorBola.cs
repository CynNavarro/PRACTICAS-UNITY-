...
public class ControladorBola : MonoBehaviour
{
    ...
    void LanzarBola()
    {
        ...
        // ✅ Comprobación del Rigidbody antes de usarlo
        if (rb!=null)
        {
        ...
        {
            Debug.LogWarning("⚠️ El Rigidbody no está asignado en " + gameObject.name);
        }

        // PISTA: Iniciar seguimiento de la cámara (si existe)
        if (cameraFollow != null)
        {
            cameraFollow.SeguirBola;
        }
    }
        ...
        void OnCollisionEnter(Collision collision)
    {
            ...
            if (collision.gameObject.CompareTag("Pin"))
        {
            ...
            {
               ;
                invoke(nameof(CalcularPuntaje), 0f);
